...
describe('concat', function() {
    ...
    context('concat', function() {
        it('basics', function(done) {
            var callOrder = [];
            async.concat([1, 3, 2], concatIteratee.bind(this, callOrder)).then((result) => {
    ...
    context('concatLimit', function() {
        ...
        it('limit exceeds size', function(done) {
            var callOrder = [];
            async.concatLimit([3, 2, 2, 1], 10, concatIteratee.bind(this, callOrder)).then((result) => {
        ...
        it('limit equal size', function(done) {
            var callOrder = [];
            async.concatLimit([3, 2, 2, 1], 4, concatIteratee.bind(this, callOrder)).then((result) => {
              expect(result).to.eql([3, 4, 2, 3, 2, 3, 1, 2]);
              expect(callOrder).to.eql([1, 2, 2, 3]);
              done();
            });
    ...
    context('concatSeries', function() {
        it('basics', function(done) {
            ...
            async.concatSeries([1,3,2], iteratee).then((results) => {
