...
describe("eachOf", function() {
    ...
    it('forEachOf', function(done) {
        var args = [];
        async.forEachOf({ a: 1, b: 2 }, forEachOfIteratee.bind(this, args)).then(() => {
    ...
    it('forEachOf with array', function(done) {
        var args = [];
        async.forEachOf([ "a", "b" ], forEachOfIteratee.bind(this, args)).then(() => {
    ...
    it('forEachOf with Set (iterators)', function(done) {
        ...
        set.add("a");
        set.add("b");
        async.forEachOf(set, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([0, "a", 1, "b"]);
          done();
        });
    });
    ...
    it('forEachOf with Map (iterators)', function(done) {
        ...
        map.set(1, "a");
        map.set(2, "b");
        async.forEachOf(map, forEachOfIteratee.bind(this, args)).then(() => {
    ...
    it('forEachOfSeries', function(done) {
        var args = [];
        async.forEachOfSeries({ a: 1, b: 2 }, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([ "a", 1, "b", 2 ]);
          done();
        });
    });
    ...
    it('forEachOfSeries with array', function(done) {
        var args = [];
        async.forEachOfSeries([ "a", "b" ], forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([ 0, "a", 1, "b" ]);
          done();
        });
    });
    ...
    it('forEachOfSeries with Set (iterators)', function(done) {
        ...
        set.add("a");
        set.add("b");
        async.forEachOfSeries(set, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([0, "a", 1, "b"]);
          done();
        });
    });
    ...
    it('forEachOfSeries with Map (iterators)', function(done) {
        ...
        map.set(1, "a");
        map.set(2, "b");
        async.forEachOfSeries(map, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([0, [1, "a"], 1, [2, "b"]]);
          done();
        });
    });
    ...
    it('forEachOfLimit limit exceeds size', function(done) {
        ...
        async.forEachOfLimit(obj, 10, forEachOfIteratee.bind(this, args)).then(() => {
    ...
    it('forEachOfLimit limit equal size', function(done) {
        var args = [];
        var obj = { a: 1, b: 2, c: 3, d: 4, e: 5 };
        async.forEachOfLimit(obj, 5, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([ "a", 1, "b", 2, "c", 3, "d", 4, "e", 5 ]);
          done();
        });
    });
    ...
    it('forEachOfLimit with array', function(done) {
        var args = [];
        var arr = [ "a", "b" ];
        async.forEachOfLimit(arr, 1, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([ 0, "a", 1, "b" ]);
          done();
        });
    });
    ...
    it('forEachOfLimit with Set (iterators)', function(done) {
        ...
        set.add("a");
        set.add("b");
        async.forEachOfLimit(set, 1, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([0, "a", 1, "b"]);
          done();
        });
    });
    ...
    it('forEachOfLimit with Map (iterators)', function(done) {
        ...
        map.set(1, "a");
        map.set(2, "b");
        async.forEachOfLimit(map, 1, forEachOfIteratee.bind(this, args)).then(() => {
          expect(args).to.eql([0, [1, "a"], 1, [2, "b"]]);
          done();
        });
    });
