...
describe("filter", function () {
    ...
    it('filter', function(done){
        async.filter([3,1,2], filterIteratee).then((results) => {
    ...
    it('filterSeries', function(done){
        async.filterSeries([3,1,2], filterIteratee).then((results) => {
          expect(results).to.eql([3,1]);
          done();
        });
    });
...
describe("reject", function () {
    ...
    it('reject', function(done){
        async.reject([3,1,2], filterIteratee).then((results) => {
    ...
    it('rejectSeries', function(done){
        async.rejectSeries([3,1,2], filterIteratee).then((results) => {
          expect(results).to.eql([2]);
          done();
        });
    });
