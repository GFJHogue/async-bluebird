...
describe('groupBy', function() {
    ...
    context('groupBy', function() {
        it('basics', function(done) {
            var callOrder = [];
            async.groupBy([1, 3, 2], groupByIteratee.bind(this, callOrder)).then((result) => {
        ...
        it('handles multiple matches', function(done) {
            var callOrder = [];
            async.groupBy([1, 3, 2, 2], groupByIteratee.bind(this, callOrder)).then((result) => {
    ...
    context('groupByLimit', function() {
        ...
        it('limit exceeds size', function(done) {
            var callOrder = [];
            async.groupByLimit([3, 2, 2, 1], 10, groupByIteratee.bind(this, callOrder)).then((result) => {
              expect(result).to.eql({2: [1], 3: [2, 2], 4: [3]});
              expect(callOrder).to.eql([1, 2, 2, 3]);
              done();
            });
        ...
        it('limit equal size', function(done) {
            var callOrder = [];
            async.groupByLimit([3, 2, 2, 1], 4, groupByIteratee.bind(this, callOrder)).then((result) => {
              expect(result).to.eql({2: [1], 3: [2, 2], 4: [3]});
              expect(callOrder).to.eql([1, 2, 2, 3]);
              done();
            });
