...
describe("detect", function () {
    ...
    it('detect', function(done){
        var call_order = [];
        async.detect([3,2,1], detectIteratee.bind(this, call_order)).then((result) => {
    ...
    it('detect - mulitple matches', function(done){
        var call_order = [];
        async.detect([3,2,2,1,2], detectIteratee.bind(this, call_order)).then((result) => {
          call_order.push('callback');
          expect(result).to.equal(2);
        });
        setTimeout(function(){
    ...
    it('detectSeries', function(done){
        var call_order = [];
        async.detectSeries([3,2,1], detectIteratee.bind(this, call_order)).then((result) => {
          call_order.push('callback');
          expect(result).to.equal(2);
        })
        setTimeout(function(){
    ...
    it('detectSeries - multiple matches', function(done){
        var call_order = [];
        async.detectSeries([3,2,2,1,2], detectIteratee.bind(this, call_order)).then((result) => {
          call_order.push('callback');
          expect(result).to.equal(2);
        });
        setTimeout(function(){
    ...
    it('detectLimit', function(done){
        var call_order = [];
        async.detectLimit([3, 2, 1], 2, detectIteratee.bind(this, call_order)).then((result) => {
          call_order.push('callback');
          expect(result).to.equal(2);
        });
        setTimeout(function() {
    ...
    it('detectLimit - multiple matches', function(done){
        var call_order = [];
        async.detectLimit([3,2,2,1,2], 2, detectIteratee.bind(this, call_order)).then((result) => {
          call_order.push('callback');
          expect(result).to.equal(2);
        });
        setTimeout(function(){
